...
def load_clip_to_cpu(cfg):
    ...
    design_details = {"trainer": 'IVLP',
                      ...
                      "language_ctx": cfg.TRAINER.COCOOP.N_CTX,
                      "cfg": cfg}
...
class PromptLearner(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        if cfg.KD.FIRST_TRAIN == False and cfg.KD.SECOND_TRAIN != False:
            ...
            if ctx_init:
                print_info("CoCoOp is using the second init and the ctx_init should be: a photo of a X*n_ctx_teacher")
                ...
                print_info("CoCoOp is using the second init and the ctx_init should be: X*(n_ctx_teacher+n_ctx_student)")
    ...
    def forward(self, im_features, ctx_teacher=None):
        ...
        for ctx_shifted_i in ctx_shifted:
            ...
            pts_i = self.construct_prompts(ctx_i, prefix, suffix, ctx_teacher=ctx_teacher)  # (n_cls, n_tkn, ctx_dim)
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label=None):
        ...
        prompts = self.prompt_learner(image_features, self.prompt_learner_teacher.ctx)
...
class CasPL_CoCoOp(TrainerX):
    ...
    def build_model(self):
        ...
        for name, param in self.model.named_parameters():
            ...
            if any(keyword in name for keyword in ["teacher"]):
                param.requires_grad_(False)
