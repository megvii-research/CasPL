    ...
    def __init__(self, cfg, classnames, clip_model):
        ...
        if ctx_init:
            if cfg.KD.FIRST_TRAIN == False and cfg.KD.SECOND_TRAIN != False:
                ...
                print_info("Coop is using the second init and the ctx_init should be: a photo of a X*n_ctx_teacher")
            ...
            if cfg.KD.FIRST_TRAIN == False and cfg.KD.SECOND_TRAIN != False:
                ...
                n_ctx_teacher = cfg.KD.N_CTX_VISION
                n_ctx = n_ctx_student + n_ctx_teacher
                print_info("Coop is using the second init and the ctx_init should be: X*(n_ctx_teacher+n_ctx_student)")
                # random initialization
                if cfg.TRAINER.COOP.CSC:
                    print("Initializing class-specific contexts")
                    ctx_vectors = torch.empty(n_cls, n_ctx_student, ctx_dim, dtype=dtype)
                else:
                    print("Initializing a generic context")
                    ctx_vectors = torch.empty(n_ctx_student, ctx_dim, dtype=dtype)

                print_info("CoOp is using the second the init")
